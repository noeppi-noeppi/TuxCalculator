...
import io.github.noeppi_noeppi.tux_calculator.math.MDefault.{absolute, acos, acosh, acot, acoth, acsc, acsch, and, asec, asech, asin, asinh, atan, atan2, atanh, call, cbrt, ceil, ceil2, clamp, cos, cosh, cot, coth, crossP, csc, csch, degree, degreeSign, dice, divide, dotP, e, equal, factorial, fc, fib, floor, floor2, fmap, foldl, foldla, foldr, foldra, foldv, foldva, fparams, gcd, gmean, greater, greater_equal, has, hmean, hypot, implic, inf, int, integ, is_element, knuth, lcm, len, lerp, list, list0, lmap, ln, log, log10, lower, lower_equal, max, mean, min, modulo, multiply, nCr, nPr, nand, negate, negateTilde, nimplic, nor, not, not_element, not_equal, or, pi, pit, power, prime, probablePrime, prod, radian, rand, rand0, rand2, randchoice, randint, range, range2, reverse, rknuth, root, round, round2, sec, sech, seq, sgn, sin, sinh, slice, sqrt, subtract, sum, tan, tanh, vec, vecA, vecAdd, vecMul, vecN, vecNorm, xor}
...
class ParserBuilder private() {
  ...
  def addDefault(): ParserBuilder = {
    ...
    func ++= List(sin, cos, tan, asin, acos, atan, sinh, cosh, tanh, sqrt, cbrt, ceil, floor, ln, log10,
      ...
      nCr, asinh, acosh, atanh, acoth, asech, acsch, pit, list0, list, vec, lmap, len, range, range2, slice, reverse,
      sgn, dotP, crossP, vecN, vecA, vecNorm, vecAdd, vecMul, fib, seq, has, lerp)
    op ++= List(MDefault.add, subtract, multiply, divide, power, modulo, equal, lower, greater, not_equal,
      lower_equal, greater_equal, is_element, not_element)

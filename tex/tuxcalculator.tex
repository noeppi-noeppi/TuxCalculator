% arara: clean: { extensions: [ aux, toc, dvi, pdf ] }
% arara: latex
...
\begin{document}
    ...
    \begin{longtable}{p{0.18\textwidth}p{0.02\textwidth}p{\dimexpr0.8\textwidth-3\tabcolsep\relax}}
    ...
    \begin{longtable}{p{0.2\textwidth}p{\dimexpr0.8\textwidth-3\tabcolsep\relax}}
        ...
        $ \mathrm{zip}(l_1, l\dots) $              & Takes any non-zero amount of some same-sized lists or vectors and produces a new list or vector, whose element at index $ i $ is a list of all the elements at index $ i $ in the original lists or vecors. For example $ zip([1,2],[3,4]) $ yields $ [[1,3],[2,4]] $. \\
        $ \mathrm{merge}(f, l_1, l\dots) $         & Takes any non-zero amount of some same-sized lists or vectors and produces a new list or vector, whose element at index $ i $ is the function $ f $ applied to all the elements at index $ i $ in the original lists or vecors. For example $ merge({@+},[1,i],[1,4]) $ yields $ [1, 4 + 1i] $. \tabgap
    ...
    \begin{longtable}{p{0.2\textwidth}p{\dimexpr0.8\textwidth-3\tabcolsep\relax}}
        ...
        \verb|#fib|     & A function for the fibonacci sequence.
                          Indices start at $ 1 $. \\

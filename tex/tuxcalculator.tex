...
\begin{document}
    ...
    \begin{longtable}{p{0.2\textwidth}p{\dimexpr0.8\textwidth-3\tabcolsep\relax}}
        ...
        $ \mathrm{bernoulli}(n) $                  & Computes the bernoulli numbers $ B_n^{-} $. $ \mathrm{bernoulli}(1) = -\frac{1}{2} $. \\
        $ \mathrm{Bernoulli}(n) $                  & Computes the bernoulli numbers $ B_n^{+} $. $ \mathrm{Bernoulli}(1) = \frac{1}{2} $. \tabgap
    ...
    \begin{longtable}{p{0.2\textwidth}p{\dimexpr0.8\textwidth-3\tabcolsep\relax}}
        ...
        \verb|#bezout|    & Takes two numbers and yields a list containing the \textsl{B\'ezout coefficients} of those numbers. \\
